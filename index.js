...
const allLocked = currentGames.every(g => g.status !== 'pre');
if (allLocked) {
document.getElementById('picks-content').innerHTML = '<div class=\"no-games\"><div class=\"emoji\">🏈</div><h3>It\'s the offseason!</h3><p>No picks right now — check back when the new season kicks off in September.</p></div>';
return;
